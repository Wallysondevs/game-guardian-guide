...
export function LessonNav({ onComplete }: LessonNavProps) {
  ...
  return (
    <>
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-full bg-[#a855f7] text-white font-medium shadow-lg shadow-purple-500/25"
          >
      ...
      <div className="fixed bottom-0 left-0 right-0 lg:left-72 bg-[#1a1a2e]/95 backdrop-blur-xl border-t border-purple-500/20 z-40">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden sm:flex items-center gap-2 text-xs text-gray-400">
                ...
                <div className="w-16 h-1.5 bg-[#0f0f1a] rounded-full overflow-hidden">
                  <div
              ...
              <Button
                ...
                className={completed ? "bg-[#a855f7]/20 text-purple-400 border-purple-500/40" : "bg-[#a855f7] text-white hover:bg-[#9333ea]"}
              >
                {completed ? (
                  <>
